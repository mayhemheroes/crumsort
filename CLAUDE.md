...
## Run Information
- Mayhem Run: mayhemheroes/crumsort/crumsort-fuzz/1
- Git Commit: 388d2aa0adf42afd65e6199a08354ccbcc28c2c5
- Original Image: ghcr.io/mayhemheroes/crumsort:main
- CI URL: https://github.com:443/mayhemheroes/crumsort//actions/runs/3768076611
...
- `rlenv/source/crumsort/` - Source code (build from this location)
...
3. **Extract build steps**: Move build commands to `rlenv/mayhem/data/scripts/build.sh` that builds from `/rlenv/source/crumsort/`
...
- Source code should be at `/rlenv/source/crumsort/` in the container
- Build script should work from `/rlenv/source/crumsort/`
